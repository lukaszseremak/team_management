...
def map_entity_to_api_model(entity: entities.Team) -> models.Team:
    return models.Team(uid=str(entity.uid), name=entity.name)


@router.post("", response_model=models.Team, status_code=201)
async def create(data: models.CreateTeamRequest, request: Request) -> models.Team:
...
async def get_all(request: Request) -> List[models.Team]:
...
async def delete(uid: UUID, request: Request) -> models.DeleteResponse:
...
async def edit(uid: UUID, data: models.EditTeamRequest, request: Request) -> models.Team:
